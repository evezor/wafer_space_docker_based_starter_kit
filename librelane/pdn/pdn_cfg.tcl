...
# This scaffold core is SRAM-free, so we do NOT source pdn_5v_sram.tcl /
# pdn_3v3_sram.tcl: those add PDN grids for SRAM macro instances that do not
# exist here and make OpenROAD.GeneratePDN fail with [PDN-1030] "Unable to find
# instance". If a future engine instantiates an SRAM macro, restore the
# conditional source below (and add the matching macro + PDN entries in
# librelane/macros/).
