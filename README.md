...
- ✅ **Hardens to a clean GDSII** — the example produces a manufacturable layout (DRC, LVS, and antenna all passing) for the default `1x1` slot.
...
│   ├── slot_defines.svh       # per-slot pad budgets (1x1 = 12 in / 40 bidir / 2 analog)
